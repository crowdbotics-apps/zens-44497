"""
Django settings for zens_44497 project.
...
WSGI_APPLICATION = 'zens_44497.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "zens_44497 API",
    "DESCRIPTION": "API documentation for zens_44497 App",
    "VERSION": "v1",
}
